...
<DIV>
	&gt;&gt;<B><a href="<%=request.getContextPath() %>/index.jsp">论坛首页</a></B>&gt;&gt;${board.boardname}
</DIV>
<br/>
<!--      新帖        -->
	<DIV>
...
<!--       表 头           -->
			<TR class="tr2">
				...
				<TD style="WIDTH: 45%" align="center">文章</TD>
			...
			<c:forEach items="${pagebean}" var="tp">
				...
				<c:if test="${tp.uname==user.uname }">
					<TD style="FONT-SIZE: 12px" align="center">
						...
						<a onclick="confirm('确定删除?')?location.href='topic?flag=hostDel&topicid=${tp.topicid}&boardid=${param.boardid}':''" href="javascript:void(0)" >删除</a>
